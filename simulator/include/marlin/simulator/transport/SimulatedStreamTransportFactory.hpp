#ifndef MARLIN_SIMULATOR_STREAM_SIMULATEDTRANSPORTFACTORY_HPP
#define MARLIN_SIMULATOR_STREAM_SIMULATEDTRANSPORTFACTORY_HPP

#include "marlin/simulator/transport/SimulatedStreamTransport.hpp"
...
namespace marlin {
    namespace simulator {
        ...
        >
        class SimulatedStreamTransportFactory : public NetworkListener<NetworkInterfaceType> {
        public:
            using SelfType = SimulatedStreamTransportFactory<
                    EventManager,
            ...
            using TransportType = SimulatedStreamTransport<
                    EventManager,
                    NetworkInterfaceType,
                    TransportDelegateType
            >;
        ...
        public:
            ...
            SimulatedStreamTransportFactory(
                    NetworkInterfaceType& interface,
                    EventManager& manager
            );
...
//Impl
        ...
        template<
                ...
                typename TransportDelegateType
        >
        int SimulatedStreamTransportFactory<
                EventManager,
                NetworkInterfaceType,
                ListenDelegateType,
                TransportDelegateType
        ...
        if(status < 0) {
        SPDLOG_ERROR("SimulatedStreamTransportFactory {}: Listen failure: {}", this->addr.to_string());
...
template<
        ...
        typename TransportDelegateType
>
void SimulatedStreamTransportFactory<
        EventManager,
        NetworkInterfaceType,
        ListenDelegateType,
        TransportDelegateType
