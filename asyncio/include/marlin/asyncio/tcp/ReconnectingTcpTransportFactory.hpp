#ifndef MARLIN_ASYNCIO_RECONNECTINGTCPTRANSPORTFACTORY_HPP
#define MARLIN_ASYNCIO_RECONNECTINGTCPTRANSPORTFACTORY_HPP

#include <uv.h>
#include "marlin/core/Buffer.hpp"
#include "marlin/core/SocketAddress.hpp"
#include "ReconnectingTcpTransport.hpp"
...
class ReconnectingTcpTransportFactory {
private:
	uv_tcp_t *socket;
	core::TransportManager<ReconnectingTcpTransport<TransportDelegate>> transport_manager;
	...
	struct ConnPayload {
		ReconnectingTcpTransportFactory<ListenDelegate, TransportDelegate> *factory;
...
public:
	...
	ReconnectingTcpTransportFactory();
	~ReconnectingTcpTransportFactory();

	ReconnectingTcpTransportFactory(ReconnectingTcpTransportFactory const&) = delete;
	...
	ReconnectingTcpTransport<TransportDelegate> *get_transport(
...
template<typename ListenDelegate, typename TransportDelegate>
ReconnectingTcpTransportFactory<ListenDelegate, TransportDelegate>::
ReconnectingTcpTransportFactory() {
	socket = new uv_tcp_t();
}
...
template<typename ListenDelegate, typename TransportDelegate>
ReconnectingTcpTransport<TransportDelegate> *
ReconnectingTcpTransportFactory<ListenDelegate, TransportDelegate>::
get_transport(
	core::SocketAddress const &addr
) {
...
#endif // MARLIN_ASYNCIO_RECONNECTINGTCPTRANSPORTFACTORY_HPP
