#ifndef MARLIN_DOT_ABCI
#define MARLIN_DOT_ABCI
...
public:
	...
	Abci(core::SocketAddress dst) : connect_timer(this), dst(dst) {
		...
		if(boost::filesystem::exists("./.marlin/keys/abci/dot")) {
			// Load existing keypair
			std::ifstream sk("./.marlin/keys/abci/dot", std::ios::binary);
			...
			std::ofstream sk("./.marlin/keys/abci/dot", std::ios::binary);
