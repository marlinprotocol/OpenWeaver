...
int main(int argc, char **argv) {
	...
	std::string discovery_addr = "0.0.0.0:" STR(MARLIN_BRIDGE_DEFAULT_DISC_PORT);
	std::string pubsub_addr = "0.0.0.0:" STR(MARLIN_BRIDGE_DEFAULT_PUBSUB_PORT);
	std::string lpftcp_bridge_addr = "0.0.0.0:" STR(MARLIN_BRIDGE_DEFAULT_LISTEN_PORT);
